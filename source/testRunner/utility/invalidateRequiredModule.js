...
exports.invalidateRequiredModule = invalidateRequiredModule;
exports.invalidateRequiredModuleEventHandler = invalidateRequiredModuleEventHandler;
 ...
 **/
function invalidateRequiredModule({
  fileArray
}) {
...
function invalidateRequiredModuleEventHandler({
  mochaInstance
}) {
